...
public class BookingManager
{
    ...
    // Constructor
    public BookingManager(String fileName, PassengerStore ps, VehicleManager vm, Passenger p, Booking b) {
...
//                    or a carriage-return '\r', or a newline '\n'
    ...
    public void writeBookingDataToFile(String fileName) throws FileNotFoundException {
        ...
        for (Booking b : this.bookingList) {
            pw.print(b.getBookingId() + ",");
            pw.print(b.getPassengerId() + ",");
            pw.print(b.getVehicleId() + ",");

            LocalDateTime bookTime = b.getBookingDateTime();

            pw.print(bookTime.getYear() + ",");
            pw.print(bookTime.getMonthValue() + ",");
            pw.print(bookTime.getDayOfMonth() + ",");

            int pId = b.getPassengerId();
            String IdForInput = Integer.toString(pId);
            Passenger p = passengerStore.findPassengerById(IdForInput);

            LocationGPS startLoc = p.getLocation();

            pw.print(startLoc.getLatitude() + ",");
            pw.print(startLoc.getLongitude() + ",");

            LocationGPS endLoc = b.getEndLocation();

            pw.print(endLoc.getLatitude() + ",");
            pw.print(endLoc.getLongitude() + ",");
